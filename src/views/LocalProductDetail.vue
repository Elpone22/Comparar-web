      ...
      <v-row no-gutters>
        ...
        <v-col cols="12" md="6" class="pa-6">
          ...
          <v-card-subtitle class="text-h6 mb-1">
            {{ selectedStore ? `Vista de ${selectedStore.store}` : 'Comparación de precios locales' }}
          </v-card-subtitle>
...
const loadProduct = async () => {
  try {
    ...
    console.error('Error al cargar el producto local:', error)
  } finally {
    loading.value = false
  }
}
